...
var sortedUniqSkills = _.sortBy(_.uniq(_.flatten(_.map(arr, 'skills'))));
console.log(sortedUniqSkills);

var sortedByFriendsAmount = _.map(_.orderBy(arr, 'friends.length'), 'name');
console.log(sortedByFriendsAmount);

var uniqUserFriends = _.uniq(_.map(_.flatten(_.map(arr,'friends')),'name'));
console.log(uniqUserFriends);
